...
API_ID = int(environ.get('API_ID', '27404245'))
API_HASH = environ.get('API_HASH', '0d29022d8220d12598424337fc493a4c')
OWNER_ID = environ.get('OWNER_ID', '7624037616')
...
CHAT_GROUP = int(environ.get("CHAT_GROUP", "-1002317832654"))

# Admins, Channels & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6974765148').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002374491956') #Channel / Group Id for force sub ( make sure bot is admin )
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002317832654') # support group id ( make sure bot is admin )
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002374491956') # request channel id ( make sure bot is admin )
...
#Auto approve 
CHAT_ID = [int(app_chat_id) if id_pattern.search(app_chat_id) else app_chat_id for app_chat_id in environ.get('CHAT_ID', '-1001728245691').split()]
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001991480157')) #Log channel id ( make sure bot is admin )
DUMP_CHNL = int(environ.get('DUMP_CHNL', '-1002201388457'))

# Verify
VERIFY = bool(environ.get('VERIFY', False)) # Verification On ( True ) / Off ( False )
HOWTOVERIFY = environ.get('HOWTOVERIFY', 'https://t.me/howtoverifybot/8') # How to open tutorial link for verification
...
BOT_USERNAME = environ.get("BOT_USERNAME", "kiss_movies_bot")
BOT_NAME = environ.get("BOT_NAME", "ᴅᴇᴠɪʟ ᴍᴏᴠɪᴇs ʙᴏᴛ")
BOT_ID = environ.get("BOT_ID", "7159885131")
S_GROUP = environ.get('S_GROUP', "helpkissu")
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002218271135'))
